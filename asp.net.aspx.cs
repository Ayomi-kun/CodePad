// running a command only when the form is submitted
    ...
    // another way to do this is to add a button click event "OnClick" to the button by referencing it to the button ID and this creates an event in the .cs file(back end).
...
//just like Console.write for cli c# applications, this is for web application
    Responce.Write("Hello from webforms application");
